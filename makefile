OPT = -g
SOURCES =  simplehero.c ../bitguy/linmath.c ../bitguy/utils.c renderer.c coroutines.c simplehero-ai.c circle.c sdl_utils.c uivector.c event.c sdl_event.c lisp_parser.c ld32_game.c lisp_interpreter.c game_controller.c game_state.c vox.c vox_internal.c vox_raster.c lisp_compiler.c lisp_types.c lisp_std_types.c ../bitguy/mem.c
CC = gcc
TARGET = run
OBJECTS =$(SOURCES:.c=.o)
...
CFLAGS = -I ../bitguy/ -Itcc -I../libconcurrency-read-only/libconcurrency/ -std=c11 -c $(OPT) -Wall -Wextra -Werror=implicit-function-declaration -Wformat=0  -g3 -O0 -D_GNU_SOURCE
all: $(TARGET)
$(TARGET): $(OBJECTS)
